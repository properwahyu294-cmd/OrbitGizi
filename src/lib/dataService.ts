...
export const DEFAULT_BENEFICIARIES: any[] = [
  {
    id: "ben_ngk_001",
    name: "Maria Florida Loda",
    parentName: "Siprianus Loda",
    nik: "5316014502210001",
    gender: "Perempuan",
    age: "3 Tahun 2 Bulan",
    category: "Balita",
    location: {
    ...
    isPetugasDinkesHadir: true,
    initialWeightKg: 11.2,
    initialHeightCm: 88.5,
    initialStatusGizi: "Normal",
    weightRecords: [
      { period: "Januari 2026", weightKg: 10.8, heightCm: 87.2, statusGizi: "Normal", measuredAt: "2026-01-15" },
      { period: "Februari 2026", weightKg: 11.0, heightCm: 88.0, statusGizi: "Normal", measuredAt: "2026-02-14" },
      { period: "Maret 2026", weightKg: 11.2, heightCm: 88.5, statusGizi: "Normal", measuredAt: "2026-03-12" }
    ],
    notes: "Penerima rutin MBG & PMT Posyandu Mbay"
  },
  {
    id: "ben_ngk_002",
    name: "Yohanes Baptista Riba",
    parentName: "Antonius Riba",
    nik: "5316011208220002",
    gender: "Laki-laki",
    age: "2 Tahun 6 Bulan",
    category: "Balita",
    location: {
      ...
      kelurahan: "Danga",
      dusun: "Dusun Danga Barat",
      posyandu: "Posyandu Melati II"
    },
    isReceivedMBG: true,
    isReceivedPMT: true,
    attendanceStatus: "Mengunjungi Posyandu",
    ...
    isPetugasPosyanduHadir: true,
    initialWeightKg: 9.8,
    initialHeightCm: 82.0,
    initialStatusGizi: "Risiko Stunting",
    weightRecords: [
      { period: "Januari 2026", weightKg: 9.4, heightCm: 81.0, statusGizi: "Risiko Stunting", measuredAt: "2026-01-10" },
      { period: "Februari 2026", weightKg: 9.6, heightCm: 81.5, statusGizi: "Risiko Stunting", measuredAt: "2026-02-11" },
      { period: "Maret 2026", weightKg: 9.8, heightCm: 82.0, statusGizi: "Risiko Stunting", measuredAt: "2026-03-10" }
    ],
    notes: "Dalam pemantauan intensif ahli gizi puskesmas"
  },
  {
    id: "ben_ngk_003",
    name: "Theresa Siga (Ibu Hamil)",
    parentName: "Yoseph Siga",
    nik: "5316025509950003",
    gender: "Perempuan",
    age: "29 Tahun",
    category: "Ibu Hamil",
    location: {
    ...
    isPetugasDesaHadir: true,
    isPetugasPosyanduHadir: true,
    initialWeightKg: 54.0,
    initialHeightCm: 156.0,
    initialStatusGizi: "Normal",
    weightRecords: [
      { period: "Januari 2026", weightKg: 52.0, heightCm: 156.0, statusGizi: "Normal", measuredAt: "2026-01-18" },
      { period: "Februari 2026", weightKg: 53.1, heightCm: 156.0, statusGizi: "Normal", measuredAt: "2026-02-18" },
      { period: "Maret 2026", weightKg: 54.0, heightCm: 156.0, statusGizi: "Normal", measuredAt: "2026-03-15" }
    ],
    notes: "Usia kehamilan 28 minggu, PMT Biskuit Ibu Hamil lancar"
  },
  {
    id: "ben_ngk_004",
    name: "Elisabeth Murni (Ibu Menyusui)",
    parentName: "Emanuel Murni",
    nik: "5316034103980004",
    gender: "Perempuan",
    age: "26 Tahun",
    ...
    isPetugasDesaHadir: true,
    isPetugasPosyanduHadir: true,
    initialWeightKg: 58.5,
    initialHeightCm: 158.0,
    initialStatusGizi: "Normal",
    weightRecords: [
      { period: "Januari 2026", weightKg: 57.0, heightCm: 158.0, statusGizi: "Normal", measuredAt: "2026-01-20" },
      { period: "Februari 2026", weightKg: 58.0, heightCm: 158.0, statusGizi: "Normal", measuredAt: "2026-02-20" },
      { period: "Maret 2026", weightKg: 58.5, heightCm: 158.0, statusGizi: "Normal", measuredAt: "2026-03-18" }
    ],
    notes: "Menyusui bayinya usia 4 bulan (ASI Eksklusif)"
  },
  {
    id: "ben_ngk_005",
    name: "Angela Merici Nenga",
    parentName: "Paskalis Nenga",
    nik: "5316016010230005",
    gender: "Perempuan",
    age: "1 Tahun 8 Bulan",
    category: "Balita",
    location: {
    ...
    isPetugasDesaHadir: true,
    isPetugasPosyanduHadir: true,
    initialWeightKg: 10.1,
    initialHeightCm: 80.5,
    initialStatusGizi: "Normal",
    weightRecords: [
      { period: "Januari 2026", weightKg: 9.8, heightCm: 79.5, statusGizi: "Normal", measuredAt: "2026-01-12" },
      { period: "Februari 2026", weightKg: 10.0, heightCm: 80.0, statusGizi: "Normal", measuredAt: "2026-02-12" },
      { period: "Maret 2026", weightKg: 10.1, heightCm: 80.5, statusGizi: "Normal", measuredAt: "2026-03-12" }
    ],
    notes: "Pertumbuhan teratur sesuai kurva KMS"
  },
  {
    id: "ben_ngk_006",
    name: "Petrus Canisius Bria",
    parentName: "Dominikus Bria",
    nik: "5316011504240006",
    gender: "Laki-laki",
    age: "1 Tahun 1 Bulan",
    category: "Balita",
    location: {
    ...
    isPetugasPosyanduHadir: true,
    initialWeightKg: 8.5,
    initialHeightCm: 73.0,
    initialStatusGizi: "Gizi Kurang",
    weightRecords: [
      { period: "Januari 2026", weightKg: 8.0, heightCm: 71.5, statusGizi: "Gizi Kurang", measuredAt: "2026-01-15" },
      { period: "Februari 2026", weightKg: 8.2, heightCm: 72.2, statusGizi: "Gizi Kurang", measuredAt: "2026-02-14" },
      { period: "Maret 2026", weightKg: 8.5, heightCm: 73.0, statusGizi: "Gizi Kurang", measuredAt: "2026-03-12" }
    ],
    notes: "Diberikan PMT Pemulihan dari Puskesmas Mbay"
  },
  {
    id: "ben_ngk_007",
    name: "Martha Dhiu (Ibu Hamil KEK)",
    parentName: "Gorgonius Dhiu",
    nik: "5316026211990007",
    gender: "Perempuan",
    age: "26 Tahun",
    category: "Ibu Hamil",
    location: {
    ...
    isPetugasDesaHadir: true,
    isPetugasPosyanduHadir: true,
    initialWeightKg: 46.5,
    initialHeightCm: 152.0,
    initialStatusGizi: "Risiko Stunting",
    weightRecords: [
      { period: "Januari 2026", weightKg: 44.8, heightCm: 152.0, statusGizi: "Risiko Stunting", measuredAt: "2026-01-10" },
      { period: "Februari 2026", weightKg: 45.6, heightCm: 152.0, statusGizi: "Risiko Stunting", measuredAt: "2026-02-11" },
      { period: "Maret 2026", weightKg: 46.5, heightCm: 152.0, statusGizi: "Risiko Stunting", measuredAt: "2026-03-10" }
    ],
    notes: "Ibu hamil Kurang Energi Kronis (KEK), pendampingan gizi intensif"
  },
  {
    id: "ben_ngk_008",
    name: "Benedicta Clara Wene",
    parentName: "Stefanus Wene",
    nik: "5316016801210008",
    gender: "Perempuan",
    age: "4 Tahun 2 Bulan",
    category: "Balita",
    location: {
    ...
    isPetugasDesaHadir: true,
    isPetugasPosyanduHadir: true,
    initialWeightKg: 13.8,
    initialHeightCm: 96.0,
    initialStatusGizi: "Normal",
    weightRecords: [
      { period: "Januari 2026", weightKg: 13.2, heightCm: 94.8, statusGizi: "Normal", measuredAt: "2026-01-18" },
      { period: "Februari 2026", weightKg: 13.5, heightCm: 95.5, statusGizi: "Normal", measuredAt: "2026-02-18" },
      { period: "Maret 2026", weightKg: 13.8, heightCm: 96.0, statusGizi: "Normal", measuredAt: "2026-03-15" }
    ],
    notes: "Siswa PAUD Pembina Mangaruda, menerima paket MBG harian"
  },
  {
    id: "ben_ngk_009",
    name: "Veronika Bupu (Ibu Menyusui)",
    parentName: "Bartholomeus Bupu",
    nik: "5316035005970009",
    gender: "Perempuan",
    age: "28 Tahun",
    category: "Ibu Menyusui",
    location: {
    ...
    initialHeightCm: 155.0,
    initialStatusGizi: "Normal",
    weightRecords: [
      { period: "Januari 2026", weightKg: 53.5, heightCm: 155.0, statusGizi: "Normal", measuredAt: "2026-01-12" },
      { period: "Februari 2026", weightKg: 54.2, heightCm: 155.0, statusGizi: "Normal", measuredAt: "2026-02-12" },
      { period: "Maret 2026", weightKg: 55.0, heightCm: 155.0, statusGizi: "Normal", measuredAt: "2026-03-12" }
    ],
    notes: "Ibu menyusui anak kedua usia 7 bulan"
  },
  {
    id: "ben_ngk_010",
    name: "Josephus Nuga",
    parentName: "Sebastianus Nuga",
    nik: "5316010507200010",
    gender: "Laki-laki",
    age: "5 Tahun 7 Bulan",
    category: "Balita",
    location: {
    ...
    isPetugasDesaHadir: true,
    isPetugasPosyanduHadir: true,
    initialWeightKg: 16.5,
    initialHeightCm: 104.0,
    initialStatusGizi: "Normal",
    weightRecords: [
      { period: "Januari 2026", weightKg: 15.8, heightCm: 102.5, statusGizi: "Normal", measuredAt: "2026-01-20" },
      { period: "Februari 2026", weightKg: 16.1, heightCm: 103.2, statusGizi: "Normal", measuredAt: "2026-02-20" },
      { period: "Maret 2026", weightKg: 16.5, heightCm: 104.0, statusGizi: "Normal", measuredAt: "2026-03-18" }
    ],
    notes: "Siswa TK St. Antonius Boawae penerima MBG"
  }
];
