...
const SEED_VILLAGES: Village[] = [
  {
    ...
    pilar4_mbg_realized: 18,
    pilar4_mbg_target: 18,
    pilar4_pmt_realized: 18,
    pilar4_pmt_target: 18,
    pilar4_home_visit: 18,
    pilar4_home_visit_target: 18,
  ...
  },
  {
    ...
    pilar3_validasi_data: true,
    pilar3_real_time_update: false,
    pilar4_mbg_realized: 8,
    pilar4_mbg_target: 10,
    pilar4_pmt_realized: 3,
    pilar4_pmt_target: 5,
    pilar4_home_visit: 3,
    pilar4_home_visit_target: 5,
    pilar4_posyandu_aktif: 1,
  ...
  },
  {
    ...
    pilar3_validasi_data: true,
    pilar3_real_time_update: false,
    pilar4_mbg_realized: 4,
    pilar4_mbg_target: 10,
    pilar4_pmt_realized: 1,
    pilar4_pmt_target: 5,
    pilar4_home_visit: 1,
    pilar4_home_visit_target: 5,
    pilar4_posyandu_aktif: 1,
    ...
    pilar5_stunting_curr: 5,
    pilar5_wasting_prev: 3,
    pilar5_wasting_curr: 3,
    pilar5_target_accuracy: 60
  }
];
